...
import { 
  Search, Info, Package, Zap, Pencil, Database, Scale, Droplets, 
    ...
    <div className="space-y-6">
                    ...
                    >
                      ...
                      <div className="absolute top-2 right-2 flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                        <Link 
                          ...
                          className="p-2 bg-slate-900/80 hover:bg-blue-600 text-white rounded-lg backdrop-blur-sm transition-all animate-in fade-in zoom-in duration-200"
                          onClick={e => e.stopPropagation()}
                        >
                          <Pencil className="w-4 h-4" />
                        </Link>
                        <div className="bg-slate-900/80 hover:bg-red-600 text-white rounded-lg backdrop-blur-sm transition-all cursor-pointer animate-in fade-in zoom-in duration-200" onClick={e => e.stopPropagation()}>
                          <DeleteAction id={cat.id} />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-5 flex-1 flex flex-col cursor-pointer" onClick={() => openModal(cat)}>
                      <div className="flex justify-between items-start mb-3">
                        <div className="flex-1">
                          <h3 className="text-lg font-bold text-white leading-tight group-hover:text-blue-400 transition-colors">{cat.modelNumber}</h3>
                      ...
                      <div className="mt-auto border-t border-slate-800/80 pt-4 flex justify-between text-center">
      ...
      {selectedCat && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8 animate-in fade-in duration-200">
          ...
          <div className="relative glass-panel border-white/10 max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-2xl animate-in zoom-in-95 duration-200">
            {/* Modal Header */}
              ...
              <div className="space-y-5">
                ...
                {selectedCat.pricing && (
                  <div className="p-5 bg-gradient-to-r from-blue-600/20 to-indigo-600/20 rounded-2xl border border-blue-500/30 flex items-center justify-between shadow-xl">
                    ...
                    <div className="text-right">
                      <p className="text-2xl font-black text-white animate-pulse-subtle">
                        {selectedCat.pricing.final_price.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
